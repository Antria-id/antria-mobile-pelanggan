...
class _EditProfileFormWidgetState extends State<EditProfileFormWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                    ...
                    children: [
                      CircleAvatar(
                        ...
                        backgroundImage: (selectedImage == null &&
                                state.pelangganModel.profilePicture!.isNotEmpty)
                            ? NetworkImage(
      ...
      bottomNavigationBar:
          BlocBuilder<PelangganProfileBloc, PelangganProfileState>(
        builder: (context, state) {
          if (state is PelangganProfileError) {
            return const SizedBox.shrink();
          }
          return BlocConsumer<UpdatePelangganBloc, UpdatePelangganState>(
