...
List<OrderTransactionResponse> orderTransactionResponseFromJson(String str) =>
    List<OrderTransactionResponse>.from(
        json.decode(str).map((x) => OrderTransactionResponse.fromJson(x)));

String orderTransactionResponseToJson(List<OrderTransactionResponse> data) =>
...
class OrderTransactionResponse {
  ...
  factory OrderTransactionResponse.fromJson(Map<String, dynamic> json) =>
      OrderTransactionResponse(
